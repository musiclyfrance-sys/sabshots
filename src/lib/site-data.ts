...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    images: [
      { src: '/assets/paris-showcase-01.jpg', alt: 'Paris photo session by SabShots with an Eiffel Tower view over the Seine', wide: true },
      { src: '/assets/paris-showcase-05.jpg', alt: 'Editorial Paris photo session by SabShots on a footbridge over the Seine', wide: true },
